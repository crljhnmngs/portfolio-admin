        ...
        <>
            <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                <div className="flex flex-col gap-5 xl:flex-row  xl:items-start xl:justify-between">
                    <div className="flex flex-col  xl:items-start w-full gap-6 xl:flex-row">
                            ...
                            <div className="grid grid-cols-1 gap-4  lg:gap-7 2xl:gap-x-32">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-gray-800 dark:text-white/90 break-all">
                                        https://drive.google.com/file/d/1dpKex3ZumzxstHFyibMFnQ-aqIpqQHdy/view?usp=sharing
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-gray-800 dark:text-white/90 break-all">
                                        https://calendly.com/manigoscarljohn/interview-meeting
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            >
                                ...
                                >
                                    <path
                                        ...
                                        2.809 1.304 3.495.997.108-.776.417-1.305.76-1.605-2.665-.3-5.467-1.334-5.467-5.93 
                                        0-1.31.469-2.38 1.236-3.22-.123-.303-.535-1.523.117-3.176 
                                        ...
                                        1.233 1.91 1.233 3.22 0 4.61-2.807 
                                        5.625-5.479 5.921.429.37.812 1.096.812 
                                        2.21 0 1.595-.014 2.877-.014 3.268 
                ...
                <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
                    <div className="px-2 pr-14">
                        ...
                        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                            Update your details to keep your portfolio
                            up-to-date.
                        </p>
                    </div>
