...
export const LocalizedInfoCard = () => {
    ...
    const { generalInfo, isLoading: isGeneralInfoLoading } =
    ...
    return (
        <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            {isGeneralInfoLoading || isLocalizedInfoLoading ? (
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                                ...
                                <div>
                                    ...
                                    <div
                                        className="text-sm font-medium text-gray-800 dark:text-white/90 prose dark:prose-invert max-w-none"
